...
<div class="locations location_single">
	...
	<div class="location_image_wrapper">
		<?php echo wp_kses( $post_thumbnail_src, 'post' ); ?>
	</div>
	<?php endif; ?>
	...
	<div class="locations_gmap">
		<iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="<?php echo esc_url( $location_data['google_maps_iframe_url'] ); ?>"></iframe>
	</div>
	<?php endif; ?>
</div>